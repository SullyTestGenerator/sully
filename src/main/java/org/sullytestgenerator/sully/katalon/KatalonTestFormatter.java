 ...
 */
package org.sullytestgenerator.sully.katalon;

import java.util.List;

import org.sullytestgenerator.sully.SullyCommand;
import org.sullytestgenerator.sully.SullyTestFormatter;

/**
 * KatalonTestFormatter.
 * 
 * This matches the format used by the Katalon Recorder tool. According
 * to their website that tool is a lightweight web browser extension for 
 * record and playback. It is a Selenium IDE-compatible alternative.
 * The tool is not open-source, but it is free to download and use.
 * The tool can be used as an extension with Chrome and Firefox browsers.
 * 
 * The Selenium IDE file format had one 'test case' per file.  
 * The Katalon Recorder tool file format has one 'test suite' per file,
 * with one or more 'test cases' within the 'test suite'.
 * 
...
public class KatalonTestFormatter implements SullyTestFormatter {
   ...
   public void formatOpenTestSuite(List<String> output, String suiteName) {
      ...
      output.add("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">" + CR);
